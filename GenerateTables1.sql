...
CREATE TABLE IF NOT EXISTS `DTUGRP16`.`Account Type` (
  ...
  INDEX `fk_Account Type_Branch_idx` (`RegNo` ASC),
  CONSTRAINT `fk_Account Type_Branch`
    FOREIGN KEY (`RegNo`)
    REFERENCES `DTUGRP16`.`Branch` (`RegNo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `DTUGRP16`.`Account` (
  ...
  INDEX `fk_Account_Branch_idx` (`RegNo` ASC),
...
CREATE TABLE IF NOT EXISTS `DTUGRP16`.`Transaction` (
  ...
  INDEX `fk_Transaction_Account1_idx` (`AccountNumber` ASC, `RegNo` ASC),
  ...
  CONSTRAINT `fk_Transaction_Account`
    ...
    REFERENCES `DTUGRP16`.`Account` (`AccountNumber`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
